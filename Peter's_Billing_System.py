#### Tkinder project for creating a department billing system:
...
class Bill_App:
    def __init__(self,root):
        ...
        title = Label(self.root, text="General Department Store", bd=12, relief=GROOVE, fg=fg_color, bg=bg_color,font=("times new roman", 30, "bold"), pady=3).pack(fill=X)
    ...
    def welcome_soft(self):
            ...
            self.txt.insert(END, "       Welcome To Peter's Retail\n")
